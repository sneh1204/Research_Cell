...
<body>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <strong>Success! Event added successfully!</strong>
      </div>
      <?php
      }
      ?>
      <form name="eform" action="<?=base_url();?>index.php/Ctrl_functions/addEvent" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="row form-group">
            <div class="col col-md-3" id="label-form"><label for="text-input" class="form-control-label">Name Of Event :</label></div>
              <div class="col-12 col-md-6"><input type="text" id="text-input" maxlength="200" name="ename" placeholder="Event Name" class="form-control" required><small class="form-text text-muted">Name of the event to display</small>
             </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3" id="label-form"><label for="text-input" class="form-control-label">Event Date :</label></div>
              <div class="col-12 col-md-6"><input type="text" id="datepicker" value="<?=date('m/d/Y');?>" name="edate" placeholder="Event Date" class="form-control" required><small class="form-text text-muted">Select Event Data</small>
             </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3" id="label-form"><label for="text-input" class="form-control-label">Event Link :</label></div>
              <div class="col-12 col-md-6"><input type="text" id="text-input" name="elink" maxlength="200" placeholder="Event Link" class="form-control" required><small class="form-text text-muted">External Event redirect link</small>
             </div>
        </div>
        <div class="row form-group">
          <div class="col col-md-3" id="label-form"><label for="file-input" class=" form-control-label">Upload Event Image :</label></div>
         <div class="col-12 col-md-6"><input type="file" id="file-input" name="eimage" class="form-control-file" accept="image/*" required></div>
         </div>
         <div class="row form-group">
          <div class="col col-md-3" id="label-form"><label for="file-input" class=" form-control-label">Upload Event Collage :</label></div>
         <div class="col-12 col-md-6"><input type="file" id="file-input" name="ecimage" class="form-control-file" accept="image/*" required></div>
         </div>
         <div class="row form-group">
         ...
         <div class="row form-group">
            <div class="col col-md-3" id="label-form"><label for="text-input" class="form-control-label">Event Details :</label></div>
              <div class="col-12 col-md-6"><textarea name="content" id="editor" maxlength="1000"></textarea><small class="form-text text-muted">Add event details</small>
              <input type="hidden" id="etype" name="etype" value="completed"/>
          </div>
        </div>
    ...
    <script>
      $("#title").html("Admin | Add Event");
      $(document).ready(function() {
        $('.breadcrumbs .page-title h1').html('Add Event');
