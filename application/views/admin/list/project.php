...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <strong>Project edited successfully!</strong>
                                </div>
                                <?php
                                }
                                ?>
                                &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="<?=base_url();?>index.php/Ctrl_add/project">+ Add new Project</a>
                                ...
                                <table id="bootstrap-data-table" class="table table-bordered">
                                    ...
                                    foreach($projects as $data){
                                        echo '<tr><td>'.$data->id.'</td><td>'.$data->title.'</td><td>'.$data->collab.'</td><td><a style="color:green;" href="'.base_url().'index.php/Ctrl_projects/project/'.$data->id.'" target="__blank">View</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:blue;" href="'.base_url().'index.php/Ctrl_edit/project/'.$data->id.'">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color: red;" href="'.base_url().'index.php/Ctrl_del/project/'.$data->id.'">Delete</a></td></tr>';
                                    }
                                    ?>
                                    </tbody>
                                </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.breadcrumbs .page-title h1').html('Projects');
