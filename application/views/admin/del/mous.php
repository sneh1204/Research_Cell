...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-12">
                        Are you sure you want to delete MoUs `<strong><?=$name;?></strong>`?
    ...
    <script>
    function goBack(){
        window.location.href="<?=base_url();?>index.php/Ctrl_list/mous";
    }
    var $ = jQuery.noConflict();
    $("#title").html("Admin | Delete MoUs");
    $(document).ready(function() {
        $('.breadcrumbs .page-title h1').html('Delete MoUs');
        ...
        $('.breadcrumbs .text-right li').eq(2).html('Delete');
          $("#submit").on("click",function(){
            $.ajax({
            url:"<?=base_url();?>index.php/Ctrl_functions/delMous/<?=$id?>",
            type:"POST",
            success:function(result){
            if(result != '0'){
                window.location.href="<?=base_url();?>index.php/Ctrl_list/mous/deleted";
            }
            else{
                alert("MoUs doesnt exist!");
            }
            }
        });
        });
