...
<html>
  <?php $this->load->view('head'); ?>
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box" style="margin-bottom: 0px;">
			<h2 style="text-align:center; color:#191970;">Student Publications</h2>
		</div>
	</div>
	<div id="colorlib-counter" class="colorlib-counters" style="background-image: url(<?=base_url();?>dist/images/home/back1.jpg);" data-stellar-background-ratio="0.5">
		...
		<div class="colorlib-blog colorlib-light-grey" style="padding-top: 0px;">
			<div class="container" style="width:90%">
				...
				<div class="col-md-8">
				<a style="float: right;" id="add" class="btn btn-primary" href="<?=base_url()?>index.php/Ctrl_sform">Add your Publication</a>
				...
				<table frame="box" class="table table-borderless" style="margin-left: 1%;width: 15%;background-color:#F8F8F8;color:black;">
					...
					<tr class="typelink active" id="selected" data-type="student_paper"><td><a href="#top"><i id="arrow" class="fa fa-arrow-right" aria-hidden="true"></i> Journal/Conference</a></td></tr>
					<tr class="typelink" data-type="student_book"><td><a href="#top">Books</a></td></tr>
					<tr class="typelink" data-type="student_chapter"><td><a href="#top">Chapters in Books</a></td></tr>
					<tr class="typelink" data-type="student_copyright"><td><a href="#top">Copyright</a></td></tr>
					<tr class="typelink" data-type="student_patent"><td><a href="#top">Patent</a></td></tr>
					<tr class="typelink" data-type="student_tech"><td><a href="#top">Tech Article</a></td></tr>
					<tr class="typelink" data-type="student_certi"><td><a href="#top">Certification</a></td></tr>
				</table>
				</div>
				</div>
			</div>
  ...
  <?php $this->load->view('scripts'); ?>
	...
	$(document).ready(function(){
		getDataByFilter("student_paper", "0", "0");
		if($('#sticky').length){
			var el = $('#sticky');
		...
		$.ajax({
          ...
          success:function(result){
			...
			switch(type){
				...
				break;
				case 'student_certi':
					$("#maintable").html('<tr class="subrow"><th style="width: 5%;">Sr. no</th><th style="width: 30%">Certi Name</th><th>Author</th><th>Detail</th><th>Date</th></tr>');
					for(i = 0; i < output.length; i++){
  ...
  <script>
  $("#pagetitle").html("Research Cell | Student Publications");
