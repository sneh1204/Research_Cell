...
<div class="container">
    ...
    <br>
        ...
        <tr class="typelink active"><td><a href="<?=base_url()?>index.php/Ctrl_tform/addTechArticle/"><i class="fa fa-arrow-right" aria-hidden="true"></i> Tech Article</a></td></tr>
    ...
    $("#submit").click(function(e){
      if($("#email").val() == "" || $("#dept option:selected").val() == "0" || $("#topic").val() == "" || $("#scholar").val() == "" || $("#name").val() == "" || $("#publisher").val() == "" || $("#date").val() == "" || $("#link").val() == ""){
        ...
        $.ajax({
          url: "<?=base_url();?>index.php/Ctrl_publications/addTechArticle/",
          type: "POST",
          data: {email: $("#email").val(), topic: $("#topic").val(), name: $("#name").val(), role: $("#role").val(), publisher: $("#publisher").val(), date: date, year: year, link: $("#link").val(), dept: $('#dept option:selected').val(), fname: $('#fname').html(), scholar: $("#scholar").val()},
          success:function(result){
            if(result == '0'){
    ...
    $("body").on("click", ".editme", function(){
        ...
        $.ajax({
          url: "<?=base_url();?>index.php/Ctrl_publications/deleteTechArticle",
          type: "POST",
