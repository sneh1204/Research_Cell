...
<div class="container">
    ...
    <strong>Please enter your SAKEC Faculty join date!</strong>
    </div>
...
<div class="gototop js-top">
  ...
  $("#submit").on("click", function(e){
    if($('#jdate').val() == ""){
        ...
        $.ajax({
          url: "<?=base_url();?>index.php/Ctrl_publications/addFacultyJoinDate/",
          type: "POST",
          data: {date: $("#jdate").val()},
          success:function(result){
            if(result == '1'){
              window.location.href = "<?=base_url()?>index.php/Ctrl_tform/addPublication";
            }
          }
        });
        return;
